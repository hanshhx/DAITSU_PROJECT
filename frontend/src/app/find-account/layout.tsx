...
export const metadata: Metadata = {
  ...
  // 사용자가 이 레이아웃이 적용된 페이지(정보 찾기 관련)에 접속하면, 탭 제목이 "다잇슈 대전 | 정보 찾기"로 바뀝니다.
  title: "다잇슈 대전 | 정보 찾기",
};
...
export default function Layout({
  children, // 6. 이 레이아웃이 감싸고 있는 '실제 페이지 내용물'을 전달받습니다. (예: page.tsx의 내용)
}: Readonly<{
...
// Next.js 서버가 /find-account 경로로 들어온 요청을 받습니다.

// 이 경로에 해당하는 layout.tsx 파일을 찾아서 읽습니다.

// 먼저 export const metadata를 확인합니다. 여기서 title: "다잇슈 대전 | 정보 찾기" 정보를 가져와서, HTML 문서의 머리말(<head>)에 제목을 심어줍니다.

// 2. 레이아웃 구조 형성 (Composition)

// 서버는 Layout 함수를 실행합니다.

// 이때, 실제 페이지 내용물인 page.tsx (아이디 찾기 입력 폼 등)를 실행하여 그 결과물을 children이라는 변수에 담습니다.

// 그리고 Layout 함수에게 이 children을 전달합니다. "자, 여기 입력 폼 가져왔으니 네가 가진 **심플한 틀(PlainLayout)**로 포장해 줘."
